...
*/
	onAfterInitialize()
	{
		...
		// this.pict.providers.PictRouter.addRoute('Legal', this.pict.views.DisasterLegal.render.bind(this.pict.views.DisasterLegal));
        // this.pict.providers.PictRouter.addRoute('DisasterList', this.pict.views.DisasterList.render.bind(this.pict.views.DisasterList));
		...
		this.pict.providers.PictRouter.addRoute('/DynamicEntityManagement/InitializeEntity/:EntityName',
			(pData) =>
			{
